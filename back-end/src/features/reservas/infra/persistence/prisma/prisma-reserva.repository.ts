...
import {
  ReservaRepositoryOutPort,
  CriarReservaData,
} from '../../../application/ports/out/reserva-repository.out.port';
import { Reserva } from '../../../domain/entities/reserva.entity';
import { ReservaMapper } from '../../../application/mappers/reserva.mapper';

@Injectable()
export class PrismaReservaRepository implements ReservaRepositoryOutPort {
  ...
  async criar(data: CriarReservaData): Promise<Reserva> {
    ...
    return ReservaMapper.toDomain(record);
  }
  ...
  async buscarTodas(): Promise<Reserva[]> {
    ...
    return records.map((r) => ReservaMapper.toDomain(r));
  }
